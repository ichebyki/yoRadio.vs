...
const ScrollConfig apSettConf     PROGMEM = {{ TFT_FRAMEWDT, 240-TFT_FRAMEWDT-16, 2, WA_LEFT }, 140, false, MAX_WIDTH, 0, 2, 30 };
...
const FillConfig   metaBGConf     PROGMEM = {{ 0, 38, 0, WA_LEFT }, DSP_WIDTH, 1, false };
...
const VUBandsConfig bandsConf     PROGMEM = { 24, 75, 4, 2, 7, 2 };
...
const MoveConfig weatherMoveVU    PROGMEM = { 8, 97, MAX_WIDTH };
